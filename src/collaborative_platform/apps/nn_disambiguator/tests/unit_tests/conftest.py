...
def nn_disambiguator__db_setup(django_db_setup, django_db_blocker):
    with django_db_blocker.unblock():
        ...
        path_to_fixture = os.path.join(SCRIPT_DIR, 'database_fixture', 'nn_disambiguator_tests_db_fixture.json')

...
urlpatterns = [
    ...
    path('<int:file_id>/version/<int:version>/', api.file_version, name='file_version'),
    ...
    path('<int:file_id>/version/<int:version>/download/', api.download_file_version, name='file_version_download'),
